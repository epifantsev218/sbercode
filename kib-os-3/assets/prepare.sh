...
oc process -f "${os_dir}/ingress-template.yml" --param-file "${os_dir}/ingress-params.env" -o yaml | oc apply -f
# http
...
oc process -f "${os_dir}/easy.yml" --param-file "${os_dir}/easy-server-params.env" -o yaml | oc apply -f
# cert
...
oc process -f "${os_dir}/simple.yml" --param-file "${os_dir}/simple-server-params.env" -o yaml | oc apply -f
# mutual TLS
sed "s/MUTUAL_URL_PLACEHOLDER/${mutual_url}/g" "${template_dir}/mutual-server-params.env" >> "${os_dir}/mutual-server-params.env"
oc process -f "${os_dir}/mutual.yml" --param-file "${os_dir}/mutual-server-params.env" -o yaml | oc apply -f
#client
